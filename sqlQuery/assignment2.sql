-- Assignment 2 SQL Statements CRUD
-- CSE 340 Database Operations
...
-- #6 Update all records to add "/vehicles" to the middle of file paths in inv_image and inv_thumbnail
UPDATE public.inventory 
