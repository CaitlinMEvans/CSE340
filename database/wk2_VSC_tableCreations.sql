-- Database rebuild file for CSE 340 Motor Company
-- This file contains all necessary SQL to rebuild the database structure

-- 1. Create account_type enum (with the correct name you used)
